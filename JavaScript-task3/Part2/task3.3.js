...
for (let i = 0; i < users.length; i++){ 
    ...
    let userAddress = '';
    let addressValues = Object.values(uDiv.address);
    for (addressPart of addressValues) {
        userAddress = userAddress + ' ' + addressPart;
    }
    userDiv.innerText = 'name: ' + uDiv.name + ', age: ' + uDiv.age + ', status: ' + uDiv.status + ', address: ' + userAddress ;
...
for (let i = 0; i < users.length; i++){ 
	...
	nameDiv.innerText = 'name: ' + uDiv.name ;
	ageDiv.innerText = 'age: ' + uDiv.age;
	statusDiv.innerText =  'status: ' + uDiv.status;
	addressDiv.innerText = 'address: ' + userAddress;
...
for (let i = 0; i < users.length; i++){ 
    ...
    for (addressPart in uDiv.address) {
			let addressItem = document.createElement ('div');
			addressItem.innerText = uDiv.address[addressPart];
